...
irm https://raw.githubusercontent.com/Huo-zai-feng-lang-li/cursor-free-vip/main/ide-reset.ps1 | iex
```
...
```powershell
# 下载主脚本
irm https://raw.githubusercontent.com/Huo-zai-feng-lang-li/cursor-free-vip/main/ide-reset.ps1 -OutFile ide-reset.ps1
.\ide-reset.ps1
...
cursor-free-vip/
├── README.md          # 项目说明文档
└── ide-reset.ps1      # 主重置脚本（核心功能）
```

### 🎯 文件说明

- **`ide-reset.ps1`** - 主要脚本，支持多 IDE 和扩展清理，功能最完整
  - 🎯 多 IDE 支持（Cursor/VS Code）
  - 🧩 扩展精确清理（Augment 保留配置）
  - 🔍 干运行模式预览
  - 🛡️ 智能备份机制
